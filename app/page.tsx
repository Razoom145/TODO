...
export default function Home() {
    ...
    return (
        ...
        <div className={"relative text-center bg-[#f2e8c9] mt-24 border-[#8b5e3c] border-[3px] mx-auto pt-10 pb-10 px-8 w-[700px] min-h-[500px] flex flex-col justify-start shadow-2xl rounded-md overflow-hidden before:content-[''] before:absolute before:left-14 before:top-0 before:w-[2px] before:h-full before:bg-red-300"}>
            ...
            {/*<button*/}
            {/*    className={"absolute bottom-10 right-8 border-[#8b5e3c] bg-[#f7f0dc] border-2 border-dashed rounded-full w-16 h-16 p-3 shadow-lg rotate-[-8deg] hover:scale-110 transition-all duration-300"}*/}
            {/*    id={"link"}*/}
            {/*>*/}
            {/*    <img*/}
            ...
            {/*<button*/}
            {/*    className={"absolute top-1/2 -right-6 border-[#8b5e3c] bg-[#f7f0dc] border-2 border-dashed rounded-full w-16 h-16 p-3 shadow-lg rotate-[14deg] hover:scale-110 transition-all duration-300"}*/}
            {/*    id={"notion"}*/}
            {/*>*/}
            {/*    <img*/}
            {/*        src={"/Notion-logo.svg"}*/}

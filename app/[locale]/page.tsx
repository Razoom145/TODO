...
export default function Home() {
    ...
    return (
        ...
        <div className="min-h-screen w-full bg-[#dfd3b6] bg-[radial-gradient(#c4b493_1px,transparent_1px)] [background-size:16px_16px] py-20 px-4 flex items-center justify-center">
            <div className={"relative text-center bg-[#f2e8c9] border-[#8b5e3c] border-[3px] mx-auto pt-10 pb-10 px-8 w-[700px] min-h-[500px] flex flex-col justify-start shadow-2xl rounded-md overflow-hidden before:content-[''] before:absolute before:left-14 before:top-0 before:w-[2px] before:h-full before:bg-red-300"}>
